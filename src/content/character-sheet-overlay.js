  ...
  function showOverlay() {
    ...
    chrome.runtime.sendMessage({ action: 'getCharacterData' }, (response) => {
      ...
      if (response && response.data) {
        ...
        console.log('✅ Character data loaded for popup:', characterData.name);
        
        // Create a simple popup window
        const popupWindow = window.open('', 'rollcloud-character-sheet', 'width=800,height=600,scrollbars=yes,resizable=yes,menubar=no,toolbar=no,location=no,status=no');
        ...
        const htmlContent = `
          ...
          <html>
          <head>
            <title>RollCloud - ${response.data.name || 'Character'}</title>
            <style>
              body {
          ...
          <body>
            <div class="container">
              ...
              <div class="header">
                <h2>🎲 ${response.data.name || 'Character'}</h2>
                <div class="info">
                  <div><strong>Class:</strong> ${response.data.class || 'Unknown'}</div>
                  <div><strong>Level:</strong> ${response.data.level || 1}</div>
                  <div><strong>Race:</strong> ${response.data.race || 'Unknown'}</div>
                </div>
              </div>
              ...
              <div class="section">
                <h3>⚡ Abilities</h3>
                <div class="grid">
                  <div class="card" onclick="roll('Strength', '1d20+${response.data.attributeMods?.strength || 0}')">
                    <strong>STR</strong>
                    <span class="bonus">${response.data.attributes?.strength || 10}</span>
                    <span class="bonus">+${response.data.attributeMods?.strength || 0}</span>
                  </div>
                  <div class="card" onclick="roll('Dexterity', '1d20+${response.data.attributeMods?.dexterity || 0}')">
                    <strong>DEX</strong>
                    <span class="bonus">${response.data.attributes?.dexterity || 10}</span>
                    <span class="bonus">+${response.data.attributeMods?.dexterity || 0}</span>
                  </div>
                  <div class="card" onclick="roll('Constitution', '1d20+${response.data.attributeMods?.constitution || 0}')">
                    <strong>CON</strong>
                    <span class="bonus">${response.data.attributes?.constitution || 10}</span>
                    <span class="bonus">+${response.data.attributeMods?.constitution || 0}</span>
                  </div>
                  <div class="card" onclick="roll('Intelligence', '1d20+${response.data.attributeMods?.intelligence || 0}')">
                    <strong>INT</strong>
                    <span class="bonus">${response.data.attributes?.intelligence || 10}</span>
                    <span class="bonus">+${response.data.attributeMods?.intelligence || 0}</span>
                  </div>
                  <div class="card" onclick="roll('Wisdom', '1d20+${response.data.attributeMods?.wisdom || 0}')">
                    <strong>WIS</strong>
                    <span class="bonus">${response.data.attributes?.wisdom || 10}</span>
                    <span class="bonus">+${response.data.attributeMods?.wisdom || 0}</span>
                  </div>
                  <div class="card" onclick="roll('Charisma', '1d20+${response.data.attributeMods?.charisma || 0}')">
                    <strong>CHA</strong>
                    <span class="bonus">${response.data.attributes?.charisma || 10}</span>
                    <span class="bonus">+${response.data.attributeMods?.charisma || 0}</span>
                  </div>
                </div>
              </div>
              ...
              <div class="section">
                <h3>🛡️ Saving Throws</h3>
                <div class="grid">
                  <div class="card" onclick="roll('STR Save', '1d20+${response.data.savingThrows?.strength || 0}')">
                    <strong>STR</strong>
                    <span class="bonus">+${response.data.savingThrows?.strength || 0}</span>
                  </div>
                  <div class="card" onclick="roll('DEX Save', '1d20+${response.data.savingThrows?.dexterity || 0}')">
                    <strong>DEX</strong>
                    <span class="bonus">+${response.data.savingThrows?.dexterity || 0}</span>
                  </div>
                  <div class="card" onclick="roll('CON Save', '1d20+${response.data.savingThrows?.constitution || 0}')">
                    <strong>CON</strong>
                    <span class="bonus">+${response.data.savingThrows?.constitution || 0}</span>
                  </div>
                  <div class="card" onclick="roll('INT Save', '1d20+${response.data.savingThrows?.intelligence || 0}')">
                    <strong>INT</strong>
                    <span class="bonus">+${response.data.savingThrows?.intelligence || 0}</span>
                  </div>
                  <div class="card" onclick="roll('WIS Save', '1d20+${response.data.savingThrows?.wisdom || 0}')">
                    <strong>WIS</strong>
                    <span class="bonus">+${response.data.savingThrows?.wisdom || 0}</span>
                  </div>
                  <div class="card" onclick="roll('CHA Save', '1d20+${response.data.savingThrows?.charisma || 0}')">
                    <strong>CHA</strong>
                    <span class="bonus">+${response.data.savingThrows?.charisma || 0}</span>
                  </div>
                </div>
              </div>
              ...
              <div class="section">
                <h3>🎯 Skills</h3>
                <div class="grid">
                  ${Object.entries(response.data.skills || {}).map(([skill, bonus]) => 
                    `<div class="card" onclick="roll('${skill.charAt(0).toUpperCase() + skill.slice(1)}', '1d20${bonus >= 0 ? '+' : ''}${bonus}')">
        ...
        overlayVisible = true;
        showNotification('Character sheet opened in new window! 🔗', 'success');
