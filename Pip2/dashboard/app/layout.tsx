        ...
        <nav className="bg-green-600 text-white p-4 shadow-lg">
          <div className="container mx-auto flex items-center justify-between">
            ...
            <div className="flex space-x-6">
              ...
              <a href="/reaction-roles" className="hover:text-green-200 transition">Reaction Roles</a>
              <a href="/changelog" className="hover:text-green-200 transition">Changelog</a>
            </div>
          </div>
        </nav>
